...
```
```{r}
total_siRNA_length <- read_delim("C:/Users/cxli9/Desktop/Li/PBI/PBI299 (Sundar Lab)/smRNA project/CLVS13/length_summaries_2020_03_12/lengths_summary.bam.sam.txt", 
    "\t", escape_double = FALSE, trim_ws = TRUE)
```
...
meta_data %>% 
  ...
  annotate(geom = "text", x = 4.5, y= 420, 
           label = "3e-8", size = 3.5, fontface = "bold", hjust = -0.1) +
