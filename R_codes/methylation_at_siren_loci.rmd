...
meth_egg_list <- list.files(path = "C:/Users/cxli9/Desktop/Li/PBI/PBI299 (Sundar Lab)/smRNA project/CLVS13/MTRsFullSet3/egg_siren/", 
...
## zygote 
```{r warning=F, message=F}
meth_zy_list <- list.files(path = "C:/Users/cxli9/Desktop/Li/PBI/PBI299 (Sundar Lab)/smRNA project/CLVS13/MTRsFullSet3/zygote_siren/", 
                        pattern = "*.mtr", full.names = T) 
...
## endosperm
```{r warning=F, message=F}
meth_en_list <- list.files(path = "C:/Users/cxli9/Desktop/Li/PBI/PBI299 (Sundar Lab)/smRNA project/CLVS13/MTRsFullSet3/endo_siren/", 
                        pattern = "*.mtr", full.names = T) 
...
meth_ov_list <- list.files(path = "C:/Users/cxli9/Desktop/Li/PBI/PBI299 (Sundar Lab)/smRNA project/CLVS13/MTRsFullSet3/ov_siren/", 
                        pattern = "*.mtr", full.names = T) 
...
str_length("C:/Users/cxli9/Desktop/Li/PBI/PBI299 (Sundar Lab)/smRNA project/CLVS13/MTRsFullSet3/endo_siren/")
```
...
meth_en_data_nice <- meth_en_data %>% 
  ...
  filter(is.na(category) == F) %>% 
   mutate(sample_ID = str_sub(id, start = 96, end = 100)) %>% 
   mutate(context = case_when(
    str_detect(id, "gz.CG.") ~ "mCG", 
    str_detect(id, "gz.CHG.") ~ "mCHG", 
    str_detect(id, "gz.CHH.") ~ "mCHH"
...
str_length("C:/Users/cxli9/Desktop/Li/PBI/PBI299 (Sundar Lab)/smRNA project/CLVS13/MTRsFullSet3/zygote_siren/")
```
...
meth_zy_data_nice <- meth_zy_data %>% 
  ...
  filter(is.na(category) == F) %>%
   mutate(sample_ID = str_sub(id, start = 98, end = 98+4)) %>% 
   mutate(context = case_when(
    str_detect(id, "gz.CG.") ~ "mCG", 
    str_detect(id, "gz.CHG.") ~ "mCHG", 
    str_detect(id, "gz.CHH.") ~ "mCHH"
...
str_length("C:/Users/cxli9/Desktop/Li/PBI/PBI299 (Sundar Lab)/smRNA project/CLVS13/MTRsFullSet3/ov_siren/")
```
...
meth_ov_data_nice <- meth_ov_data %>% 
  ...
  filter(is.na(category) == F) %>%
   mutate(sample_ID = str_sub(id, start = 94, end = 96)) %>% 
   mutate(context = case_when(
    str_detect(id, "gz.CG.") ~ "mCG", 
    str_detect(id, "gz.CHG.") ~ "mCHG", 
    str_detect(id, "gz.CHH.") ~ "mCHH"
