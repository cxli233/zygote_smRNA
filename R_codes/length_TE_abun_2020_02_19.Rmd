...
siren_graph
ggsave("siRNA_24_egg_siren_bar.svg", height = 4.5, width = 4.5)
ggsave("siRNA_24_egg_siren_bar.png", height = 4.5, width = 4.5)
```
...
* egg spec: egg - zygote: < 2.2e-16
* seedling spec: egg - zygote: < 2.2e-16
* sperm spec: sperm - zygote: < 2.2e-16
